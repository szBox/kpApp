					...
					<li v-for="(item,index) in list">
						...
						<ul class="ul-abcd">
							<li v-for='(option,index) in item.chioces' :class="{
									'optionActive': item.answerContent.indexOf(option.id) != -1}">
								<span class='option-A'>
						...
						<div class="answer-hh">
							...
							<p @click="showBtn(item.id)">
								<i>
									收藏
								</i>
								<img  src="/static/images/content-btn-selected-sc.png" alt="" />
							</p>
